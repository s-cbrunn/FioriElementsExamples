class ZCL_ZDEMO_FE_ADD_COLUM_MPC definition
  public
...
public section.
  ...
  types:
   TS_ZC_FE_ADD_COLUMNTYPE type ZCADDCOLUMN .
  types:
   TT_ZC_FE_ADD_COLUMNTYPE type standard table of TS_ZC_FE_ADD_COLUMNTYPE .

  constants GC_ZC_FE_ADD_COLUMNTYPE type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'ZC_FE_ADD_COLUMNType' ##NO_TEXT.
...
CLASS ZCL_ZDEMO_FE_ADD_COLUM_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZDEMO_FE_ADD_COLUMN_SRV' ).
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20211108200840'.                  "#EC NOTEXT
...
*   4
*&---------------------------------------------------------------------*
    CONSTANTS: co_gen_date_time TYPE timestamp VALUE '20211108200840'.
    TRY.
  ...
  method IF_SADL_GW_MODEL_EXPOSURE_DATA~GET_MODEL_EXPOSURE.
    CONSTANTS: co_gen_timestamp TYPE timestamp VALUE '20211108200841'.
    DATA(lv_sadl_xml) =
   ...
   ro_model_exposure = cl_sadl_gw_model_exposure=>get_exposure_xml( iv_uuid      = CONV #( 'ZDEMO_FE_ADD_COLUMN' )
